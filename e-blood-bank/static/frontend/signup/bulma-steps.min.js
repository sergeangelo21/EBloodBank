...
<html lang="en">
  ...
  <title>bulma-steps/bulma-steps.min.js at master · Wikiki/bulma-steps · GitHub</title>
  ...
  <meta name="request-id" content="D248:5B4E:8B13F8:CDE930:5B6124D8" data-pjax-transient>
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="YmRmMzIwYWY4ZTg3MjhhOTA3NGY2ODI3MDAyMTg2ZGU1YjkxNzI3MzhkYjBlNGQwNzJiMTExMmY3ZDNjMGVmMnx7InJlbW90ZV9hZGRyZXNzIjoiMTgwLjE5MS43OS4yNDciLCJyZXF1ZXN0X2lkIjoiRDI0ODo1QjRFOjhCMTNGODpDREU5MzA6NUI2MTI0RDgiLCJ0aW1lc3RhbXAiOjE1MzMwOTMwODEsImhvc3QiOiJnaXRodWIuY29tIn0=">
  ...
  <meta name="octolytics-dimension-user_id" content="24766179" /><meta name="octolytics-dimension-user_login" content="Wikiki" /><meta name="octolytics-dimension-repository_id" content="97702695" /><meta name="octolytics-dimension-repository_nwo" content="Wikiki/bulma-steps" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="97702695" /><meta name="octolytics-dimension-repository_network_root_nwo" content="Wikiki/bulma-steps" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="false" />
    ...
    <link rel="canonical" href="https://github.com/Wikiki/bulma-steps/blob/master/dist/js/bulma-steps.min.js" data-pjax-transient>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="97702695" data-scoped-search-url="/Wikiki/bulma-steps/search" data-unscoped-search-url="/search" action="/Wikiki/bulma-steps/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=G11TxCkzkkx7h6pDE2mzIZ+AmfHOcOTGH4DE4vYh5QNOJ8FGq9SuE8N8lb8XDYRkmG1utyBJ1Nf4PgwXjoZGUA=="
          spellcheck="false"
          autocomplete="off"
          >
          ...
          <span class="d-inline-block">
              <div class="HeaderNavlink px-0 py-2 m-0">
                <a class="text-bold text-white no-underline" href="/login?return_to=%2FWikiki%2Fbulma-steps%2Fblob%2Fmaster%2Fdist%2Fjs%2Fbulma-steps.min.js" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in; experiment:site_header_dropdowns; group:control">Sign in</a>
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/Wikiki/bulma-steps/blob/394fe0bcf5e06570a1f368d95193cd09fb3c0aa2/dist/js/bulma-steps.min.js">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:57e9031f8f51a6a9c0967757171c4357 -->

      <div class="signup-prompt-bg rounded-1">
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="f4X+kLw7HTRb10LO7o07EUHw6TF56MOfnkq0hFO6JYWPMwDxaBsu6HJqvshiXVxhR9REICHSpLOdTUshmha8cg==" />
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/Wikiki/bulma-steps/blob/master/dist/js/bulma-steps.min.js"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/Wikiki/bulma-steps/tree/v1.0.0/dist/js/bulma-steps.min.js"
              data-name="v1.0.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/Wikiki/bulma-steps/tree/v0.1.2/dist/js/bulma-steps.min.js"
              data-name="v0.1.2"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/Wikiki/bulma-steps/tree/UMDmodules/dist/js/bulma-steps.min.js"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/Wikiki/bulma-steps/tree/ImportPath/dist/js/bulma-steps.min.js"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/Wikiki/bulma-steps/tree/BulmaImportAtTopOfSass/dist/js/bulma-steps.min.js"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/Wikiki/bulma-steps/tree/1.0.3/dist/js/bulma-steps.min.js"
              data-name="1.0.3"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/Wikiki/bulma-steps/tree/1.0.2/dist/js/bulma-steps.min.js"
              data-name="1.0.2"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/Wikiki/bulma-steps/tree/1.0.1/dist/js/bulma-steps.min.js"
              data-name="1.0.1"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/Wikiki/bulma-steps/tree/1.0.0/dist/js/bulma-steps.min.js"
              data-name="1.0.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/Wikiki/bulma-steps/tree/0.2.6/dist/js/bulma-steps.min.js"
              data-name="0.2.6"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/Wikiki/bulma-steps/tree/0.2.5/dist/js/bulma-steps.min.js"
              data-name="0.2.5"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/Wikiki/bulma-steps/tree/0.2.4/dist/js/bulma-steps.min.js"
              data-name="0.2.4"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/Wikiki/bulma-steps/tree/0.2.3/dist/js/bulma-steps.min.js"
              data-name="0.2.3"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/Wikiki/bulma-steps/tree/0.2.2/dist/js/bulma-steps.min.js"
              data-name="0.2.2"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/Wikiki/bulma-steps/commit/96a7ff547dc713ff0f98ff365039b4b51aea56ba" data-pjax>
          96a7ff5
        </a>
        <relative-time datetime="2018-06-17T17:13:29Z">Jun 18, 2018</relative-time>
      </span>
      <div>
        <a rel="contributor" data-skip-pjax="true" data-hovercard-user-id="1245519" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/helmi77"><img class="avatar" src="https://avatars2.githubusercontent.com/u/1245519?s=40&amp;v=4" width="20" height="20" alt="@helmi77" /></a>
        <a class="user-mention" rel="contributor" data-hovercard-user-id="1245519" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/helmi77">helmi77</a>
          <a data-pjax="true" title="Don&#39;t activate invalid steps" class="message" href="/Wikiki/bulma-steps/commit/96a7ff547dc713ff0f98ff365039b4b51aea56ba">Don't activate invalid steps</a>
      </div>
...
<details class="details-reset details-overlay details-overlay-dark lh-default text-gray-dark float-left mr-2" id="blob_contributors_box">
    ...
    <div class="Box-header">
      ...
      <h3 class="Box-title">Users who have contributed to this file</h3>
        ...
        <ul class="list-style-none overflow-auto">
            ...
            <li class="Box-row">
              <a class="link-gray-dark no-underline" href="/helmi77">
                <img class="avatar mr-2" alt="" src="https://avatars2.githubusercontent.com/u/1245519?s=40&amp;v=4" width="20" height="20" />
                helmi77
</a>            </li>
        </ul>
          ...
          <a class="avatar-link" data-hovercard-user-id="24766179" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/Wikiki/bulma-steps/commits/master/dist/js/bulma-steps.min.js?author=Wikiki">
      <img class="avatar" src="https://avatars2.githubusercontent.com/u/24766179?s=40&amp;v=4" width="20" height="20" alt="@Wikiki" /> 
</a>    <a class="avatar-link" data-hovercard-user-id="1245519" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/Wikiki/bulma-steps/commits/master/dist/js/bulma-steps.min.js?author=helmi77">
      <img class="avatar" src="https://avatars2.githubusercontent.com/u/1245519?s=40&amp;v=4" width="20" height="20" alt="@helmi77" /> 
</a>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/Wikiki/bulma-steps/raw/master/dist/js/bulma-steps.min.js">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/Wikiki/bulma-steps/blame/master/dist/js/bulma-steps.min.js">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/Wikiki/bulma-steps/commits/master/dist/js/bulma-steps.min.js">History</a>
    </div>
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/Wikiki/bulma-steps/blame/394fe0bcf5e06570a1f368d95193cd09fb3c0aa2/dist/js/bulma-steps.min.js">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.17807s from unicorn-3748294796-781kr">GitHub</span>, Inc.</li>
